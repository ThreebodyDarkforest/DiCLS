...
def _swin_transformer(
    ...
    block: SwinTransformerBlock = None,
    downsample_layer: PatchMerging = PatchMerging,
    frozen_stages: int = 7,
    **kwargs: Any,
) -> SwinTransformer:
    ...
    if weights is not None:
        ckpt = torch.hub.load_state_dict_from_url(weights)
